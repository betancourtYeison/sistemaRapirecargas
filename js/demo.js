...
(function ($, AdminLTE) {
  ...
  var tab_button = $("<li />", {"class": "active"})
          .html("<a href='' data-target='#control-sidebar-theme-demo-options-tab' data-toggle='tab'>"
  ...
  demo_settings.append(
          ...
          + "Plantilla justa"
          + "</label>"
          + "<p>Activa la plantilla justa. No puedes usar la plantilla justa y la plantilla en caja al mismo tiempo</p>"          
          + "</div>"
          //Boxed layout
          + "<div class='form-group'>"
          + "<label class='control-sidebar-subheading'>"
          ...
          + "Plantilla en caja"
          + "</label>"
          + "<p>Activa la plantilla en caja</p>"
          + "</div>"
          //Sidebar Toggle
          + "<div class='form-group'>"
          + "<label class='control-sidebar-subheading'>"
          ...
          + "Menú Navegador"
          + "</label>"
          + "<p>Estado del menú (expandido o cerrado)</p>"
          + "</div>"          
          ...
          + "Color del menú Opciones"
          + "</label>"
          + "<p>Cambiar color entre negro y claro para el menú</p>"          
          + "</div>"
          );
  ...
  demo_settings.append("<h4 class='control-sidebar-heading'>Colores</h4>");
