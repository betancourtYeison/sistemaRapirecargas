...
/**
 * @ngdoc function
 * @name facturacionAdminApp.controller:LlamadasInterCtrlCRD
 * @description
 * # LlamadasInterCtrlCRD
 * Controller of the facturacionAdminApp
 */

//Controlador para Login la cual tiene 1 servicio llamadasInterServiceCRD con su respectivo scope
angular.module('facturacionAdminApp')
  .controller('LlamadasInterCtrlCRD', ['$scope', 'ngTableParams', 'llamadasInterServiceCRD', '$location', '$firebaseArray', 'firebaseRef', '$filter', 
    function ($scope, ngTableParams, llamadasInterServiceCRD, $location, $firebaseArray, firebaseRef, $filter) {    
