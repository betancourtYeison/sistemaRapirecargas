...
/**
 * @ngdoc function
 * @name facturacionAdminApp.controller:RecargasCtrlCRD
 * @description
 * # RecargasCtrlCRD
 * Controller of the facturacionAdminApp
 */

//Controlador para Login la cual tiene 1 servicio recargasServiceCRD con su respectivo scope
angular.module('facturacionAdminApp')
  .controller('RecargasCtrlCRD', ['$scope', 'ngTableParams', 'recargasServiceCRD', '$location', '$firebaseArray', 'firebaseRef', '$filter', 
    function ($scope, ngTableParams, recargasServiceCRD, $location, $firebaseArray, firebaseRef, $filter) {    
