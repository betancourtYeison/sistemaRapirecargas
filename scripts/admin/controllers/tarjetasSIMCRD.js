...
/**
 * @ngdoc function
 * @name facturacionAdminApp.controller:TarjetasSIMCtrlCRD
 * @description
 * # TarjetasSIMCtrlCRD
 * Controller of the facturacionAdminApp
 */

//Controlador para Login la cual tiene 1 servicio tarjetasSIMServiceCRD con su respectivo scope
angular.module('facturacionAdminApp')
  .controller('TarjetasSIMCtrlCRD', ['$scope', 'ngTableParams', 'tarjetasSIMServiceCRD', '$location', '$firebaseArray', 'firebaseRef', '$filter', 
    function ($scope, ngTableParams, tarjetasSIMServiceCRD, $location, $firebaseArray, firebaseRef, $filter) {    
